...
class Inventario(val id: Int, val idProducto: String, val idTipoInventario: Int, val idAlmacen: String, val idEmpleado: String, val cantidad: Int, val descripcion: String = "", val estado: Boolean = true) {
