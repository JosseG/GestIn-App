package com.nsgej.gestinapp.ui.menu.report.inventario
...
class RprtInventarioFragment : Fragment() {
    ...
    private var _binding: FragmentRprtInventarioBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnRegresar.setOnClickListener {
            findNavController().navigate(R.id.action_rprtInventarioFragment_to_reportesFragment)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RprtInventarioFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RprtInventarioFragment().apply {
